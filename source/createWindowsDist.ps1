...
if ([string]::IsNullOrWhiteSpace($DistRoot)) {
    $DistRoot = "C:\tloDist-V1.6Build$BundleNumber"
}
...
$ExpectedExecutables = @('search-artist-db.exe', 'tlo-gsi.exe', 'tlo-gi.exe', 'tlo-research.exe', 'tlo-reverse.exe', 'tlo-ggi.exe', 'tlo-tag.exe', 'tlo-deleteDupes.exe')
