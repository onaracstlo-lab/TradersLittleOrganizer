...
def test_v305_tagger_gui_keeps_bold_app_heading_and_uses_current_public_version():
    ...
    assert gui.TAGGER_DISPLAY_VERSION == "TLO Tagger GUI v1.0 Build 319"
...
def test_v305_public_version_matches_bundle_number():
    ...
    assert V.VERSION == "v319"
    assert V.BUNDLE_BUILD == 319
    assert V.DISPLAY_VERSION == "v1.0 Build 319"
    assert V.versioned_title("TLO Inventory GUI") == "TLO Inventory GUI v1.0 Build 319"
...
def test_v305_startup_banner_never_appends_release_change_summary():
    ...
    for debug in (False, True):
        ...
        assert banner == "Starting tlo-gi v1.0 Build 319"
...
def test_v305_all_toplevel_gui_titles_include_public_version():
    ...
    assert gui.WINDOW_TITLE == "TLO Inventory GUI v1.0 Build 319"
    assert gui.TAGGER_DISPLAY_VERSION == "TLO Tagger GUI v1.0 Build 319"
    assert UPDATER_DISPLAY_VERSION == "TLO Inventory Updater v1.0 Build 319"
